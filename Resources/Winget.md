...
winget install --id=Microsoft.dotnetRuntime.3-x86 -e &&
winget install --id=Microsoft.dotnetRuntime.3-x64 -e &&
winget install --id=Microsoft.dotnetRuntime.5-x86 -e &&
winget install --id=Microsoft.dotnetRuntime.5-x64 -e &&
